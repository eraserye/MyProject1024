...
UCLASS()
class MYPROJECT1024_API ASceneSwitcher : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION()
		void SwitchScene(class UPrimitiveComponent* OverlappedComp,
			class AActor* OtherActor,
			class UPrimitiveComponent* OtherComp,
			int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "switch")
	ALightManager* CurLight;

	TArray<AActor*> LightingManagers;
